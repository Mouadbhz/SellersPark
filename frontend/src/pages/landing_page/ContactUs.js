...
import contactUsImage from '../../pages/images/contactus.png'; // Import the image
import formBackgroundImage from '../../pages/images/back5.jpg'; // Import the form background image
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex-1 flex justify-center items-center">
        <div className="max-w-4xl w-full bg-white p-8 rounded-lg shadow-lg mt-20 flex" style={{backgroundImage: `url(${formBackgroundImage})`, backgroundSize: 'cover'}}> {/* Form background image */}
          ...
          <div className="w-3/5 flex flex-col justify-center items-center border-l-2 border-blue-800 pl-8"> {/* Adjusted width and added border */}
            ...
            <img src={contactUsImage} alt="Contact Us Image" className="w-full h-60 object-cover mt-4" /> {/* Increased size of the image and added margin-top */}
          </div>
        </div>
      </div>
    </div>
